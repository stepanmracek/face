...
public:
    static void testFeaturesGeneration(const QString &frgcPath)
    {
        ...
        Face::Biometrics::HistogramFeatures features1(cropped1, 6, 6);
        Face::Biometrics::HistogramFeatures features2(cropped2, 6, 6);
        Face::Biometrics::HistogramFeatures features3(cropped3, 6, 6);
        /*for (int i = 0; i < 6; i++)
        {
        ...
        Face::LinAlg::Vector vec1 = features1.toVector();
        Face::LinAlg::Vector vec2 = features2.toVector();
        Face::LinAlg::Vector vec3 = features3.toVector();
